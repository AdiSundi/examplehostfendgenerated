import { TextInput, Textarea, SimpleGrid, Group, Title, Button, MultiSelect, Center } from '@mantine/core';
import React from 'react';
import { useForm } from '@mantine/form';
import styles from './Rate_peers_Comprehensive_Form.module.css';

export default function Rate_peers_Comprehensive_Form() {
    const form = useForm({
        initialValues: {
    ...
    return (
        <Center>
            <form onSubmit={form.onSubmit(handleSubmit)} className={styles.form} style={{ width: '80%' }}>
                <Title
                    order={2}
                    size="h1"
